...
// with additional sorting of the input as it is a part of the submission
// judgment, from the algorithm perspective it is not needed, and in that case
// the algorithm is not performat with hashamp
